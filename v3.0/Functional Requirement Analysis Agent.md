...
Before completing analysis, determine whether sufficient information exists to understand:
...
Do not make assumptions for missing business requirements.

Do not continue downstream analysis when critical business information is unavailable.
...
Only populated when Status = NeedsClarification.
